			...
			<xsl:if test="./@isPrice!='no'">
				<div class="priceGroup">
					<div class="priceGroupValue">
						...
						<input type="text" size="2" class="myInput" onclick="clearThis(this);" out='yes' dir="ltr" rel="tooltip" data-original-title="تخفيف">
						...
						<input type="text" size="2" class="myInput" onclick="clearThis(this);" out='yes' dir="ltr" rel="tooltip" data-original-title="مازاد">
						...
						<input type="text" size="12" class="myInput" out='yes' dir="ltr" rel="tooltip" data-original-title="بهاي كل">
