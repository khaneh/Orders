...
namespace Reports {
    ...
    public class OrderForm : ReportClass {
    ...
    public class CachedOrderForm : Component, ICachedReport {
        
        public CachedOrderForm() {
        }
