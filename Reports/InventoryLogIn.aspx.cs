...
namespace Reports
{
	...
	/// </summary>
	public class InventoryLogInWebForm : System.Web.UI.Page
	{
		protected CrystalDecisions.Web.CrystalReportViewer CrystalReportViewer1;
		protected System.Web.UI.WebControls.Button Button1;
		protected System.Web.UI.HtmlControls.HtmlForm Form1;
		protected ReportManager rm = new ReportManager();
		InventoryLogIn crReport = new InventoryLogIn();
		string paramName= "LogItem_ID";
		string param;
		...
		private void Button1_Click(object sender, System.EventArgs e)
		{
			...
			if(x) 
			{
				...
				Response.Write("—”Ìœ œ—Ì«›  çﬂ œ— ’› ç«Åê—  <br>");
