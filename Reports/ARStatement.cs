...
namespace Reports {
    ...
    public class ARStatement : ReportClass {
    ...
    public class CachedARStatement : Component, ICachedReport {
        
        public CachedARStatement() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ARStatement rpt = new ARStatement();
            rpt.Site = this.Site;
            return rpt;
        }
