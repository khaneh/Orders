...
<%@ Page language="c#" Codebehind="InvPickupList.aspx.cs" AutoEventWireup="false" Inherits="Reports.InvPickupListWebForm" %>
	...
	<body bgColor="#c3dbeb" MS_POSITIONING="GridLayout">
		<center><font face="titr"></font>
			<form id="Form1" dir="rtl" method="post" runat="server">
				...
				</select></center><br--><CR:CRYSTALREPORTVIEWER id="CrystalReportViewer1" style="Z-INDEX: 100; LEFT: -3px; POSITION: absolute; TOP: 3px" runat="server" Height="362px" Width="780px" ToolTip="Order Form Preview" BestFitPage="False" HasDrillUpButton="False" HasGotoPageButton="False" HasExportButton="False" HasPageNavigationButtons="False" HasSearchButton="False" HasToggleGroupTreeButton="False" DisplayGroupTree="False" DisplayToolbar="False"></CR:CRYSTALREPORTVIEWER></form>
		</center>
