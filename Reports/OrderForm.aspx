<%@ Page language="c#" Codebehind="OrderForm.aspx.cs" AutoEventWireup="false" Inherits="Reports.WebForm1" %>
	...
	<body bgColor="#c3dbeb" MS_POSITIONING="GridLayout">
		<center><font face="titr"></font>
			<form id="Form1" method="post" runat="server">
				...
				</select></center><br--><CR:CRYSTALREPORTVIEWER id="CrystalReportViewer1" style="Z-INDEX: 100; LEFT: -24px; POSITION: absolute; TOP: 3px" runat="server" Width="700px" Height="362px" DisplayToolbar="False" DisplayGroupTree="False" HasToggleGroupTreeButton="False" HasSearchButton="False" HasPageNavigationButtons="False" HasExportButton="False" HasGotoPageButton="False" HasDrillUpButton="False" PageZoomFactor="85" BestFitPage="False" ToolTip="Order Form Preview"></CR:CRYSTALREPORTVIEWER></form>
		</center>
