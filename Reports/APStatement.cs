...
namespace Reports {
    ...
    public class APStatement : ReportClass {
    ...
    public class CachedAPStatement : Component, ICachedReport {
        
        public CachedAPStatement() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            APStatement rpt = new APStatement();
            rpt.Site = this.Site;
            return rpt;
        }
