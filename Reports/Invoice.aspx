...
<%@ Page language="c#" Codebehind="Invoice.aspx.cs" AutoEventWireup="false" Inherits="Reports.InvoiceWebForm" %>
	...
	<body bgColor="#c3dbeb" MS_POSITIONING="GridLayout">
		<center><font face="titr"></font>
			<form id="Form1" method="post" runat="server">
				...
				</select></center><br--><CR:CRYSTALREPORTVIEWER id="CrystalReportViewer1" style="Z-INDEX: 100; LEFT: 0px; POSITION: absolute; TOP: 4px" runat="server" Width="780px" Height="362px" DisplayToolbar="False" DisplayGroupTree="False" HasToggleGroupTreeButton="False" HasSearchButton="False" HasPageNavigationButtons="False" HasExportButton="False" HasGotoPageButton="False" HasDrillUpButton="False" BestFitPage="False" ToolTip="Order Form Preview" PageZoomFactor="90"></CR:CRYSTALREPORTVIEWER></form>
		</center>
