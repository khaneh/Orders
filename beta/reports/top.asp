	...
	<TD>
		...
		<TR class=alak height=25>
			...
			<%if SubmenuItem="1" then %> 
				...
				<TD align=center background="/images/MTB.gif" class='alak2'><A HREF='default.asp'>ê“«—‘ùÂ«Ì «ﬂ”·Ì</A></TD>
				<TD width=10><img src='/images/LTB.gif'></td>
			<%else %>  
				<TD width=10><img src='/images/RTS.gif'></td>
				<TD align=center background="/images/MTS.gif" class='alak'><A HREF='default.asp'>ê“«—‘ùÂ«Ì «ﬂ”·Ì</A></TD>
			...
			<TD  width=260 align=left bgcolor=<%=SelectedMenuColor%>></TD>
