...
'-------------------------------------
 pages ( 3 , 0 ) = "ÊæáíÏ"
	...
	pages (3,7)		= "ÚãáßÑÏ"
	pages (3,9)		= "æíÑÇíÔ ÚãáßÑÏ"
	pages (3,10)	= "ÒÇÑÔ ÚãáßÑÏ"
	pages (3,8)		= "ãæÌæÏí ßÇÛĞ"
'-------------------------------------
 pages ( 4 , 0 ) = "ÎÑíÏ"
	...
	pages (4,7)		= "ÊÛííÑ ŞíãÊ ÊæÇİŞ ÔÏå¡ ÏÑ ííÑí ÎÑíÏ"
	pages (4,8)		= "ÊÛííÑ İÑæÔäÏå"
'-------------------------------------
 pages ( 5 , 0 ) = "ÇäÈÇÑ"
	...
	pages (5,14) = "ËÈÊ æÑæÏ ßÇáÇí ÇÑÓÇáí ãÔÊÑí"				'E
	pages (5,15) = "ËÈÊ æÑæÏ ÇÒ ÊæáíÏ"						'F
	pages (5,16) = "ËÈÊ ßÇáÇí ãÑÌæÚí"						'G
	pages (5,17) = "æÑæÏ ÇÒ ÓÇíÑ ÇäÈÇÑåÇ"						'H
	pages (5,18) = "æÑæÏ ÇÒ ÖÇíÚÇÊ" 						'I
	pages (5,19) = "æÑæÏ ãÇÒÇÏ ÊæáíÏ" 						'J
'-------------------------------------
 pages ( 6 , 0 ) = "ÍÓÇÈÏÇÑí İÑæÔ"
	...
	pages ( 6 , 15 ) = "ÎÑæÌ İÇßÊæÑ ÇÒ ÕÏæÑ"				'F
	pages ( 6 , 16 ) = "ÎÑæÌ İÇßÊæÑ ÇÒ ÊÇííÏ"				'G
	...
	pages ( 6 , 22 ) = "ÊÛííÑÇÊ Çáİ/È ŞÈá ÇÒ ÕÏæÑ"			'M
	pages (6, 23)	 = "ÊÛííÑÇÊ Çáİ/È ÈÚÏ ÇÒ ÕÏæÑ"			'N
'-------------------------------------
...
'-------------------------------------
 pages ( 8 , 0 ) = "ÍÓÇÈÏÇÑí "
	...
	pages ( 8 , 17 ) = "ÊãÇã íÇÏÏÇÔÊ ÔÏååÇ ÑÇ ÈÊæÇäÏ ãæİŞÊ ßäÏ"	'H
'-------------------------------------
 pages ( 9 , 0 ) = "ÕäÏæŞ"
	pages ( 9 , 1 ) = "ÏÑíÇİÊ"
	pages ( 9 , 2 ) = "ÑÏÇÎÊ äŞÏ"
...
'-------------------------------------
 pages ( 12 , 0 ) = "ÓÇíÑ ÒÇÑÔ åÇí ÈÎÔ ÍÓÇÈÏÇÑí İÑæÔ"		'C
	...
	pages (12,10) = "ÒÇÑÔ ÈÑÔÊ ÇÒ İÑæÔ"			'A
'-------------------------------------
