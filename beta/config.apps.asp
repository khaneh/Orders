...
conStr = "Provider=SQLNCLI10.1;Persist Security Info=False;User ID=sefadmin;Initial Catalog=sefareshat;Data Source=.;PWD=5tgb;"
...
sub UnApproveInvoice(invoiceID,ApprovedBy)
	...
	msgBody			=	"›«ﬂ Ê— ›Êﬁ »Â œ·Ì·  €ÌÌ— ”›«—‘ „—»ÊÿÂ Ì« »Â œ·Ì· ÊÌ—«Ì‘°  Ê”ÿ "& session("CSRName") & " «“   «ÌÌœ Œ«—Ã ‘œ."
