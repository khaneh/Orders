...
//alert('hi');
	...
	if (txt2val(document.getElementsByName("totalVat")[0].value) != vat){
		document.getElementsByName("message")[0].value = "«Œÿ«—! Ã„⁄ „«·Ì«  «‘ »«Â „Ì»«‘œ.";
...
function combine()
{
	...
	if (priceNoVat > 0)
	{
		document.getElementsByName("Descriptions")[1].value = "ﬂ«€– Ê „ﬁÊ« ÃÂ  ç«Å";
	...
	document.getElementsByName("Descriptions")[0].value = "Œœ„«  ç«Å";
	...
	//---------------------------
	document.getElementsByName("Descriptions")[2].value = " Œ›Ì› —‰œ ›«ﬂ Ê—";
