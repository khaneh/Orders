...
<%	else
	...
	%>
			<TR bgcolor="<%=tmpColor%>" >
				...
				<TD style='direction:LTR;text-align:right;'><%=Separate(rs("creditLimit"))%></TD>
				<TD style='direction:LTR;text-align:right;'><%=Separate(rs("arBalance"))%></TD>
				<TD style='direction:LTR;text-align:right;'><%=Separate(rs("apBalance"))%></TD>
				<TD style='direction:LTR;text-align:right;'><%=Separate(rs("aoBalance"))%></TD>
				<TD><%=rs("realName")%></TD>
			</TR>
