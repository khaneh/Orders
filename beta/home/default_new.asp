...
<style>
	...
	.MsgBodyClass {width:100%;height:60px;overflow:auto;}
</style>
...
<TaBlE class="CustTable4" cellspacing="2" cellspacing="0" >
	...
	<Td valign="top" align="center">
		<FORM METHOD=POST ACTION="default.asp?act=changeStatus">
...
%>
				<TR bgcolor="<%=tmpColor%>" onclick="javascript:void(0);">
					...
					<TD dir="LTR" align='right'><%=RS1("Sender")%>&nbsp;</TD>
