...
%> 
		<TD align=center class='<%=styleClass%>'><A HREF='?userID=<%=userID%>&panel=1'>”›«—‘ »œÊ‰ ÅÌ‘‰ÊÌ” (<%=count%>)</A></TD>
<%
	end if %>
	<TD width=5 >&nbsp;</TD>
...
%> 
		<TD align=center class='<%=styleClass%>'><A HREF='?userID=<%=userID%>&panel=2'> «ÌÌœ ‰‘œÂ (<%=count%>)</A></TD>
<%
	end if %>
	<TD width=5 >&nbsp;</TD>
...
%> 
		<TD align=center class='<%=styleClass%>'><A HREF='?userID=<%=userID%>&panel=3'>’«œ— ‰‘œÂ (<%=count%>)</A></TD>
<%
	end if %>
	<TD width=5 >&nbsp;</TD>
...
%> 
		<TD align=center class='<%=styleClass%>'><A HREF='?userID=<%=userID%>&panel=4'> ”ÊÌÂ ‰‘œÂ (<%=count%>)</A></TD>
<%
	end if %>
	<TD width=5 >&nbsp;</TD>
...
%> 
		<TD align=center class='<%=styleClass%>'><A HREF='?userID=<%=userID%>&panel=5'>„‘ —Ì«‰ (<%=count%>)</A></TD>
<%
	end if %>
	<TD width=5 >&nbsp;</TD>
...
%> 
		<TD align=center class='<%=styleClass%>'><A HREF='?userID=<%=userID%>&panel=6'>çﬂ »—ê‘ Ì (<%=count%>)</A></TD>
<%
	end if %>
	<TD width=5 >&nbsp;</TD>
...
%> 
		<TD align=center class='<%=styleClass%>'><A HREF='?userID=<%=userID%>&panel=7'>ê“«—‘ ﬂ·Ì „”ƒÊ· Õ”«»</A></TD>
<%
	end if %>
	<TD width=5 >&nbsp;</TD>
...
<%
	if Auth("D" , 1) AND panel=1 then '”›«—‘ Â«Ì »«“
%>
	<Tr>
	<Td valign="top" align="center">
...
<%
	...
	if Auth("D" , 2) AND panel=2 then '›«ﬂ Ê— Â«Ì  «ÌÌœ ‰‘œÂ
%>
	<Tr>
	<Td valign="top" align="center">
		<table class="CustTable" cellspacing='1' style='width:90%;'>
...
%>
			<tr>
				<td colspan="8" class="CusTableHeader" style="text-align:right;background-color:#CCCC99;"><A HREF="?userID=<%=userID%>&showAll=on&panel=2">«œ«„Â œ«—œ ...</A></td>
			</tr>
<%
			end if
		else
...
<%
	...
	if Auth("D" , 3) AND panel=3 then '›«ﬂ Ê— Â«Ì  «ÌÌœ ‘œÂ (’«œ— ‰‘œÂ)
%>
	<Tr>
...
%>
			<tr>
				<td colspan="7" class="CusTableHeader" style="text-align:right;background-color:#33BB99;"><A HREF="?userID=<%=userID%>&showAll=on&panel=3">«œ«„Â œ«—œ ...</A></td>
			</tr>
<%
			end if
		else
...
<%
	...
	if Auth("D" , 4) AND panel=4 then '›«ﬂ Ê— Â«Ì ’«œ— ‘œÂ ( ”ÊÌÂ ‰‘œÂ)
%>
	<Tr>
	<Td valign="top" align="center">
		<table class="CustTable" cellspacing='1' style='width:90%;'>
...
%>
			<tr>
				<td colspan="10" class="CusTableHeader" style="text-align:right;background-color:#CCAA99;"><A HREF="?userID=<%=userID%>&showAll=on&panel=4">«œ«„Â œ«—œ ...</A></td>
			</tr>
<%
			end if
		else
...
<%
	...
	if Auth("D" , 5) AND panel=5 then 'Õ”«» Â«Ì „«‰œÂ œ«—
%>
	<Tr>
	<Td valign="top" align="center">
		<table class="CustTable" cellspacing='1' style='width:90%;'>
		<tr>
			<td colspan="10" class="CusTableHeader" style="background-color:#CC99AA;">Õ”«» Â«Ì „«‰œÂ œ«—</td>
		</tr>
		<%
...
%>
			<tr>
				...
				<td class="CusTD3"> ‰«„ —«»ÿ «Ê· </td>
				<td class="CusTD3" width='80'> „«‰œÂ ›—Ê‘</td>
			</tr>
<%
			tmpCounter=0
			Do while not RS1.eof 
				...
				if RS1("Type") = 1 then 
					AccountTitle = AccountTitle & " (›—Ê‘‰œÂ) "
				end if
...
%>
			<tr>
				<td colspan="10" class="CusTableHeader" style="text-align:right;background-color:#CC99AA;"><A HREF="?userID=<%=userID%>&showAll=on&panel=5">«œ«„Â œ«—œ ...</A></td>
			</tr>
<%
			else
%>
			<tr bgcolor='#CC99AA'>
				<td align='right' colspan=3> Ã„⁄</td>
...
<%
	...
	if Auth("D" , 6) AND panel=6 then 'çﬂ Â«Ì »—ê‘ Ì
%>
	<Tr>
	<Td valign="top" align="center">
		<table class="CustTable" cellspacing='1' style='width:90%;'>
		<tr>
			<td colspan="10" class="CusTableHeader" style="background-color:#FF9999;">çﬂ Â«Ì »—ê‘ Ì</td>
		</tr>
		<%
...
%>
			<tr class="RepTableHeader">
				<td class="CusTD3">#</td>
				<td class="CusTD3"> «—ÌŒ ”‰œ</td>
				<td class="CusTD3">‘—Õ</td>
				<td class="CusTD3">»œÂﬂ«—</td>
				<td class="CusTD3">»” «‰ﬂ«—</td>
				<td class="CusTD3"> «—ÌŒ çò</td>
			</tr>
<%			Do while not RS1.eof
				Ref1=		RS1("Ref1")
				Ref2=		RS1("Ref2")
...
%>
			<tr>
				<td colspan="10" class="CusTableHeader" style="text-align:right;background-color:#FF9999;"><A HREF="?userID=<%=userID%>&showAll=on&panel=6">«œ«„Â œ«—œ ...</A></td>
			</tr>
<%
			else
%>
...
<%
	...
	if Auth("D" , 7) AND panel=7 then 'ê“«—‘ ﬂ·Ì „”ƒÊ· Õ”«»
...
%>
			<tr>
				<td colspan="9" class="CusTableHeader" style="text-align:right;"><A HREF="?userID=<%=userID%>&panel=7&showAll=on&spanel=1">«œ«„Â œ«—œ ... ( ⁄œ«œ ﬂ· : <%=count%>)</A></td>
			</tr>
<%
			end if
		else
...
%>
			<tr>
				<td colspan="8" class="CusTableHeader" style="text-align:right;background-color:#CCCC99;"><A HREF="?userID=<%=userID%>&panel=7&showAll=on&spanel=2">«œ«„Â œ«—œ ... ( ⁄œ«œ ﬂ· : <%=count%> ›«ﬂ Ê— x ”›«—‘)</A></td>
			</tr>
<%
			end if
		else
...
%>
			<tr>
				<td colspan="7" class="CusTableHeader" style="text-align:right;background-color:#33BB99;"><A HREF="?userID=<%=userID%>&panel=7&showAll=on&spanel=3">«œ«„Â œ«—œ ... ( ⁄œ«œ ﬂ· : <%=count%>)</A></td>
			</tr>
<%
			end if
		else
...
%>
			<tr>
				<td colspan="10" class="CusTableHeader" style="text-align:right;background-color:#CCAA99;"><A HREF="?userID=<%=userID%>&panel=7&showAll=on&spanel=4">«œ«„Â œ«—œ ... ( ⁄œ«œ ﬂ· : <%=count%>)</A></td>
			</tr>
<%
			end if
		else
