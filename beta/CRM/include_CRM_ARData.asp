	...
	.CusTD4 {background-color: #CCCC66; direction: LTR; text-align: center; font-size:9pt;}
	  ...
	  <Tr>
		<Td colspan="2" valign="center" align="center">
			<BR>
			<% if Auth(2 , 1) then %><input class="GenButton" type="Button" value="ê—› ‰ ”›«—‘"onclick="window.open('../order/OrderInput.asp?act=getorder&selectedCustomer=<%=cusID%>');" <% if AccountIsDisabled then %> disabled <% end if %>> <% end if %> 
