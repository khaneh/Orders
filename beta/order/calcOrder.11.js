...
function calc_total(){
	...
	if (((sumDis - sumOver) / totalPrice * 100) >= parseInt($("#disLimitP").val()) && parseInt($("#disLimitP").val())!=100){
		$("#errMsg").html("‘„« „Ã«“ »Â œ«œ‰ «Ì‰ „Ì“«‰  Œ›Ì› ‰Ì” Ìœ! Õœ«ﬂÀ—  Œ›Ì› „Ã«“ »—«Ì ‘„« " + $("#disLimitP").val() + " œ—’œ „Ìù»«‘œ.");
		$("#Submit").css("display","none");

	} else {
		if ((sumDis - sumOver)  > parseInt($("#disLimit").val())){
			$("#errMsg").html("‘„« „Ã«“ »Â œ«œ‰ «Ì‰ „Ì“«‰  Œ›Ì› ‰Ì” Ìœ! Õœ«ﬂÀ—  Œ›Ì› „Ã«“ »—«Ì ‘„« " + echoNum($("#disLimit").val()) + " —Ì«· „Ìù»«‘œ.");
			$("#Submit").css("display","none");
		} else {
			if (sumReverse>0 && $("#reverseLimit").val()=='0'){
				$("#Submit").css("display","none");
				$("#errMsg").html("‘„« „Ã«“ »Â À»  »—ê‘  «“ ›—Ê‘ ‰Ì” Ìœ");
			} else {
