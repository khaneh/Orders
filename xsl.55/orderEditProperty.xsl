				...
				<div class="priceGroup">
					<div class="priceGroupValue">
						...
						<xsl:if test="./@showCost='yes'">
							<div>
								<input type="text" size="12" class="myInput" dir="ltr" rel="tooltip" data-placement="right" data-original-title="بهاي تمام شده" readonly="readonly">
									<xsl:attribute name="name"><xsl:value-of select="./@name"/>-cost</xsl:attribute>			
									<xsl:if test="./@disable='yes' and ./@hasValue!='yes'"><xsl:attribute name="disabled">true</xsl:attribute></xsl:if>
								</input>
							</div>
							<div>
								<input type="text" size="12" class="myInput" dir="ltr" rel="tooltip" data-placement="right" data-original-title="بهاي خريد" readonly="readonly">
