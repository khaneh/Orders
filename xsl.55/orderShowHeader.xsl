...
<!-- 				<xsl:attribute name="bgcolor">black</xsl:attribute> -->
		...
		<tr>
			...
			<tr class="grayColor">
				<td align="left" class="isPrice">پيش پرداخت:</td>
				<td align="right" class="isPrice"><xsl:value-of select="./deposit"/> ريال</td>
				<td align="left" class="isPrice">سررسيد:</td>
				<td align="right" class="isPrice"><xsl:value-of select="./dueDate"/> روز</td>
				<td align="left" class="isPrice">مهلت دريافت چك:</td>
				<td align="right" class="isPrice"><xsl:value-of select="./chequeDueDate"/> روز</td>
			</tr>
	</table>
</xsl:template>
</xsl:stylesheet>